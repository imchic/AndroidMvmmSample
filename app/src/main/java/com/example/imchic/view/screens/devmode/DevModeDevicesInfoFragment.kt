...
class DevModeDevicesInfoFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("developer_mode_device_manufacturer")?.summary = AppUtil.getProudctName()
        ...
        findPreference<Preference>("developer_mode_screen_destiny")?.summary = AppUtil.getAppMetrix(requireContext())[0]
        findPreference<Preference>("developer_mode_screen_width")?.summary = "${AppUtil.getAppMetrix(requireContext())[3]}dp"
    }
}